...
document.addEventListener('presentationInit', function() {
  var slide = app.slide.s1_7 = {
    ...
    onEnter: function(slideElement) {
      ...
      $('.s1_7__btn--2').click(function(e) {
        $('.s1_7__info-block').hide();
        presentation.popup('popup__s1_7--1');
      });
    ...
    onEnter: function(slideElement) {
      ...
      $('.s1_8__droppable--0').droppable({
        ...
        drop: function(event, ui) {
          ...
          ui.draggable.closest('.bg').css('background-image', 'url("content/img/bepanthen/bepanthen_8.jpg")');
      ...
      $('.s1_8__droppable--1').droppable({
        drop: function(event, ui) {
          ...
          $('.s1_8__info-block').hide();
          ui.draggable.closest('.bg').css('background-image', 'url("content/img/bepanthen/bepanthen_8_1.jpg")');
      ...
      $('.s1_8__droppable--2').droppable({
        drop: function(event, ui) {
          ...
          $('.s1_8__info-block').hide();
          ui.draggable.closest('.bg').css('background-image', 'url("content/img/bepanthen/bepanthen_8_2.jpg")');
      ...
      $('.s1_8__droppable--3').droppable({
        drop: function(event, ui) {
          ...
          $('.s1_8__info-block').hide();
          ui.draggable.closest('.bg').css('background-image', 'url("content/img/bepanthen/bepanthen_8_3.jpg")');
      ...
      $('.s1_9__droppable').droppable({
        ...
        drop: function(event, ui) {
          ...
          if (ui.draggable.hasClass('s1_9__draggable--1')) {
            ui.draggable.closest('.bg').css('background-image', 'url("content/img/bepanthen/bepanthen_9_1.jpg")');
          } else if (ui.draggable.hasClass('s1_9__draggable--2')) {
            ui.draggable.closest('.bg').css('background-image', 'url("content/img/bepanthen/bepanthen_9_2.jpg")');
          } else if (ui.draggable.hasClass('s1_9__draggable--3')) {
            ui.draggable.closest('.bg').css('background-image', 'url("content/img/bepanthen/bepanthen_9_3.jpg")');
          }
...
document.addEventListener('presentationInit', function() {
  var slide = app.slide.s1_11 = {
    ...
    onEnter: function(slideElement) {
      ...
      $('.s1_11__btn--1').click(function(e) {
        $('.s1_11__info-block').hide();
        presentation.popup('popup__s1_11--1');
      });
...
document.addEventListener('presentationInit', function() {
  var slide = app.slide.s1_12 = {
    ...
    onEnter: function(slideElement) {
      ...
      $('.s1_12__btn--1').click(function(e) {
        $('.s1_12__info-block').hide();
        presentation.popup('popup__s1_12--1');
      });
...
document.addEventListener('presentationInit', function() {
  var slide = app.slide.s1_18 = {
    ...
    onEnter: function(slideElement) {
      ...
      var growing = this.interval = setInterval(function() {
      growingStage++;
        switch (growingStage) {
          case 1:
